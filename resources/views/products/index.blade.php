                  ...
                  <div class="card-body">
                     <table id="listDataTable" class="table table-bordered table-striped">
                        ...
                        <tbody>
                           ...
                           <tr>
                              <td>{{ $list->name }}</td>
                              <td>{!! getStatusChangeButton($list->status,route($module.'.changeStatus',$list->slug)) !!}
                              </td>
                              <td>{{ dynamicDateFormat($list->created_at,'d-m-Y H:i A') }}</td>
                              <td>
                                 {!! getActionButtons([['key'=>'edit','url'=>route($module.'.edit',$list->slug)]]) !!}
                                 {!! getActionButtons([['key'=>'delete','url'=>route($module.'.delete',$list->slug)]]) !!}
